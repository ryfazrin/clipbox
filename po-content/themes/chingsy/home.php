<?=$this->layout('index');?>
<!-- home ini buatan ryan fazrin untuk custom get all post dengan pagination -->
<section id="content">
	<div class="content-wrap">
		<div class="container clearfix">
			<div class="col-md-8 nobottommargin clearfix">
				...
				<?php
					$posts = $this->post()->getAllPost('2', 'DESC', $this->e($page), WEB_LANG_ID);
				...
				<div class="col-md-12 text-center" style="margin-top:30px;">
					<ul class="pagination nobottommargin">
						<?=$this->post()->getAllPaging('2', $this->e($page), '1', $this->e($front_paging_prev), $this->e($front_paging_next));?>
					</ul>
				</div>
			</div>
